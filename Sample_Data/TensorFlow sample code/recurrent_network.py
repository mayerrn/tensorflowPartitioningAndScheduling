...
costmodelFile = open('recurrent_network_costmodel', 'w')
graphFile = open('recurrent_network_graph', 'w')
...
with tf.Session(config= cfg) as sess:
    ...
    while step * batch_size < training_iters:
        ...
        sess.run(optimizer, feed_dict={x: batch_x, y: batch_y},options=run_options, run_metadata=metadata)
