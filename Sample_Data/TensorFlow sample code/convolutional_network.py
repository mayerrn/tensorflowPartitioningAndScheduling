...
graphFile = open('convolutional_network_graph', 'w')
costmodelFile = open('convolutional_network_costmodel', 'w')
...
with tf.Session(config=cfg) as sess:
    ...
    while step * batch_size < training_iters:
        ...
        sess.run(optimizer, feed_dict={x: batch_x, y: batch_y,
                                       keep_prob: dropout},options=run_options, run_metadata=metadata)
